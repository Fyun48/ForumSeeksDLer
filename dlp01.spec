...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'src.downloader.clipboard_sender',
        'src.downloader.smg_integration',
        'src.gui',
        'src.gui.main_window',
        'src.gui.styles',
        ...
        'src.gui.workers',
        'src.gui.download_history_widget',
        'src.gui.extract_history_widget',
        'src.gui.extract_settings_widget',
        'src.gui.section_manager_widget',
        'src.gui.section_search_widget',
        'src.gui.section_search_manager_widget',
        'src.gui.search_download_worker',
        'src.gui.web_download_widget',
        'src.utils',
        'src.utils.logger',
        'src.utils.profile_manager',
        'src.utils.cookie_loader',
